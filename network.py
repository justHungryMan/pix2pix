...
class Generator(nn.Module):
    ...
    def forward(self, x):
        ...
        out2_4 = self.conv2_4(torch.cat((out1_2, out4_2), 1))
        out4_8 = self.conv4_8(torch.cat((out2_4, out8_4), 1))
        out8_16 = self.conv8_16(torch.cat((out4_8, out16_8), 1))
        out16_32 = self.conv16_32(torch.cat((out8_16, out32_16), 1))
        out32_64 = self.conv32_64(torch.cat((out16_32, out64_32), 1))
        out64_128 = self.conv64_128(torch.cat((out32_64, out128_64), 1))
        out128_256 = self.conv128_256(torch.cat((out64_128, out256_128), 1))
